...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        density = action(get_str('calculateDensity'),self.density,
                        'w', 'new', get_str('calculateDensityDetail'), enabled=False)
        ...
        self.actions = Struct(save=save, save_format=save_format, save_format_beginner=save_format_beginner, saveAs=save_as, open=open, close=close, resetAll=reset_all, deleteImg=delete_image,
                              ...
                              onLoadActive=(
                                  close, create, create_mode, edit_mode,density),
        ...
        self.actions.beginner = (
            ...
            zoom_in,  zoom_out, fit_window, fit_width,edit,density)
